...
C_SRCS += \
../vendor/UI/components/ui_comp_hook.c 

OBJS += \
./vendor/UI/components/ui_comp_hook.o 

C_DEPS += \
./vendor/UI/components/ui_comp_hook.d 


# Each subdirectory must supply rules for building sources it contributes
vendor/UI/components/%.o: ../vendor/UI/components/%.c
	@echo 'Building file: $<'
